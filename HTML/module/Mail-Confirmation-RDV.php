...
<body>
    <div>
        ...
        <p><strong>💅 Prestation :</strong> <?= htmlspecialchars($service['nom']) ?> </p>
        <p><strong>👩‍💼 Prothésiste :</strong> <?= htmlspecialchars($prothesiste) ?></p>
        <p><strong>⏱️ Durée :</strong> <?= $service['duree'] ?> minutes</p>

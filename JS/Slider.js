...
export function SliderImage(images, cheminDossierImage){
    ...
    // ? La fonction est exportée pour être utilisable dans d'autres fichiers
    ...
    // ? Ajoute une classe CSS à notre conteneur pour pouvoir le styliser
    ...
    // ? indexTableau = la position dans le tableau (0, 1, 2...)
        ...
        // ? Définit l'adresse de l'image en combinant le chemin du dossier et le nom du fichier
        // ? Par exemple: "./Images/Photos QuiSommesNous/IMG_3863.jpeg"
        img.alt = "Image de diaporama"; // ? Ajoute un texte alternatif pour l'accessibilité
    ...
    // ? Retourne le conteneur avec toutes les images
    // ?  Sans ce return, la fonction ne renverrait rien (undefined)
    // ? et on ne pourrait pas utiliser le slider ailleurs dans le code
}
...
function CreationDeFleches(container)
{
    ...
    FlecheGauche.src = "./Images/Fleche-gauche.png"
    ...
    FlecheDroite.src = "./Images/Fleche-droite.png"
    // Ajoute un texte alternatif pour l'accessibilité

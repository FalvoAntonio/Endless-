<?php
require_once __DIR__ . "/../../PHP/service/PDO-Connexion-BDD.php"; // Connexion à la base de données
function getCreneauxLibres($pdo, $date = null) {
    ...
    ");
    $sql->execute([$date]);
    $creneauxOccupesAvecSecondesAffiché = $sql->fetchAll(PDO::FETCH_COLUMN);
...
if (isset($_GET['ajax']) && $_GET['ajax'] == 'creneaux' && isset($_GET['date'])) {
